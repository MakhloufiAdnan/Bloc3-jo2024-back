...
import fr.bloc_jo2024.dto.AdminLoginRequestDTO;
...
public class AdminController {
     ...
     */
    @PostMapping("/login")
    public ResponseEntity<Map<String, String>> adminLogin(@Valid @RequestBody AdminLoginRequestDTO credentials, HttpServletRequest request) {
