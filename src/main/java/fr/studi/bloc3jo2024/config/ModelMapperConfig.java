...
import fr.studi.bloc3jo2024.entity.Offre; // Supposant que ContenuPanier.getOffre() retourne un type Offre
...
public class ModelMapperConfig {
    ...
    private static Long helperGetOffreId(ContenuPanier source) {
        Offre offre = source.getOffre(); // Pour éviter les appels multiples à getOffre()
        if (offre != null) {
